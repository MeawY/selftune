# Garmin and Supplement Review Prompt

Use this prompt with a Garmin daily screenshot summary, supplement log, nervous-system check-in, and subjective notes.

## Prompt

Please review the following Garmin summary, supplement log, nervous-system check-in, and subjective notes as a non-medical self-observation record.
...
```text
Paste Garmin summary, supplement log, nervous-system check-in, and subjective notes here.
```
